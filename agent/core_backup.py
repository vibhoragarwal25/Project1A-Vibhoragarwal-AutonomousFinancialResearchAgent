...
if action:
                    ...
                    if not circuit_breaker.is_available(action):
                        ...
                        observation = f"Tool {action} circuit is open due to repeated failures. Using alternative approach."
                    ...
                    try:
                        ...
                        if success:
                            ...
                            if fallbacks:
                                print(f"[ARA-1] Primary tool failed, trying fallbacks: {fallbacks}")
                                ...
                                if fallback_result.get("success"):
                                    ...
                                    circuit_breaker.record_success(
                                        fallback_result.get("fallback_tool", action)
                                    )
